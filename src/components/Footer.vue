      ...
      <div class="left">
        <div class="col-1">
          ...
          <ul>
            ...
            <li>
              <a href="https://www.instagram.com/"><instagram class="svg-icon"/></a>
            </li>
            <li>
              <a href="https://www.linkedin.com/in/mayank-singh-rathore-aa04a618a/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3BM9AhYoFSR0OXynYN9rEMLA%3D%3D"><linkedin class="svg-icon"/></a>
            </li>
          </ul>
        </div>
        <div class="col-2">
